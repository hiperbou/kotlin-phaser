...
class SpriteBounds: State() {
	...
	override fun render() {
	    ...
	    // game.debug.geom(Phaser.Point(rect.left, rect.centerY), "#ff00ff")
	    // game.debug.geom(Phaser.Point(rect.right, rect.centerY), "#ff00ff")
	    // game.debug.geom(Phaser.Point(rect.centerX, rect.top), "#ff00ff")
	    // game.debug.geom(Phaser.Point(rect.centerX, rect.centerY), "#ff00ff")
	    // game.debug.geom(Phaser.Point(rect.centerX, rect.bottom), "#ff00ff")
