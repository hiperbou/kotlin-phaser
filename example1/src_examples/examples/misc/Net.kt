...
class Net: State() {
	...
	override fun render() {
	    ...
	    game.debug.text("Query string with values : "+game.net.updateQueryString("atari", "520"),game.world.centerX-400,80)
	    game.debug.text("Query string with values : "+game.net.updateQueryString("amiga", "1200"),game.world.centerX-400,100)
