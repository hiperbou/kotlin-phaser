...
class DisplayTextWordByWord: State() {
	...
	override fun create() {
	    ...
	    text = game.add.text(32, 32, "", TextStyle(font="15px Arial",fill="#19de65" ))
	...
	fun nextLine() {
	    ...
	    //  Call the "nextWord" fun once for each word in the line (line.size)
	    game.time.events.repeat(wordDelay,  line.size, this::nextWord, this)
