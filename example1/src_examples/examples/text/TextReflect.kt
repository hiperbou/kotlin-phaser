...
class TextReflect: State() {
	...
	override fun create() {
	    ...
	    var grd = textReflect.context.createLinearGradient(0.0, 0.0, 0.0, text.canvas.height.toDouble())
