...
class MoreSprites: State() {
	...
	override fun create() {
	    ...
	    game.add.sprite(150, 200, "chick").anchor.y = 1.0
	    game.add.sprite(350, 200, "burd").anchor.y = 1.0
	    game.add.sprite(550, 200, "alien").anchor.y = 1.0
	
	    game.add.sprite(150, 350, "ufo").anchor.y = 1.0
	    game.add.sprite(350, 350, "star").anchor.y = 1.0
	    game.add.sprite(550, 350, "ship").anchor.y = 1.0
	
	    game.add.sprite(150, 500, "cat").anchor.y = 1.0
	    game.add.sprite(350, 500, "joystick").anchor.y = 1.0
	    game.add.sprite(550, 500, "joypad").anchor.y = 1.0
