...
class GroupCreation: State() {
	...
	override fun create() {
		...
		for (i in 0..6)
	    {
	        ...
	        group.create<Sprite>(120 * i, game.rnd.integerInRange(100, 400), "seacreatures", "octopus0000")
	    }
	
	    //  These are the frame names for the octopus animation. We use the generateFrames fun to help create the array.
