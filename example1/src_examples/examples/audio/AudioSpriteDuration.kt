...
class AudioSpriteDuration: State() {
	...
	override fun preload() {
	    ...
	    game.load.audio("sfx", arrayOf("assets/audio/SoundEffects/magical_horror_audiosprite.mp3", "assets/audio/SoundEffects/magical_horror_audiosprite.ogg" ))
