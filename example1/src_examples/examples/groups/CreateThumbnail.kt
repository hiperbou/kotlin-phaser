...
class CreateThumbnail: State() {
	...
	lateinit var stageBp:BitmapData
	lateinit var thumbnail:BitmapData
	...
	override fun create() {
	    ...
	    stageBp = game.make.bitmapData(800, 600)
	    ...
	    //  A Text Object
	    game.add.text(440, 530, "Click to capture", object{ var  font= "48px Arial";  var  fill= "#ff0044" })
	
	    //  Click to capture a thumbnail
	    game.input.onDown.add(this::makeThumbnail, this)
	...
	fun makeThumbnail() {
	    ...
	    thumbnail.copy(stageBp, 0, 0, 800, 600, 2, 2, 200, 150)
