...
class BounceAccelerator: State() {
	...
	override fun create() {
	    ...
	    flyer.animations.add("left", arrayOf(0, 1, 2, 3), 10, true)
	    flyer.animations.add("right", arrayOf(5, 6, 7, 8), 10, true)
