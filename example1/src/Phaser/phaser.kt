...
@JsName("Phaser.HEADLESS")
external var HEADLESS: Number
@JsName("Phaser.WEBGL_MULTI")
...
external open class Animation {
    ...
    companion object {
        //fun generateFrameNames(prefix: String, start: Number, stop: Number, suffix: String? = null, zeroPad: Number? = null): MutableList<String>
...
external open class BitmapData(game: Phaser.Game, key: String, width: Number? = null, height: Number? = null, skipPool: Boolean? = null) {
    ...
    open fun getPixelRGB(x: Number, y: Number, out: Any? = null, hsl: Boolean? = null, hsv: Boolean? = null): ColorComponents
...
: Phaser.Image(game, x, y, key) {
    ...
    open fun setFrames(overFrame: String? = null, outFrame: String? = null, downFrame: String? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: String? = null, downFrame: String? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: String? = null, downFrame: Number? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: String? = null, downFrame: Number? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: Number? = null, downFrame: String? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: Number? = null, downFrame: String? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: Number? = null, downFrame: Number? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: String? = null, outFrame: Number? = null, downFrame: Number? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: String? = null, downFrame: String? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: String? = null, downFrame: String? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: String? = null, downFrame: Number? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: String? = null, downFrame: Number? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: Number? = null, downFrame: String? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: Number? = null, downFrame: String? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: Number? = null, downFrame: Number? = null, upFrame: String? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: Number? = null, downFrame: Number? = null, upFrame: Number? ): Unit
    open fun setFrames(overFrame: Number? = null, outFrame: Number? = null, downFrame: Number? = null): Unit
...
external open class Cache(game: Phaser.Game) {
    ...
    open fun getJSON(key: String, clone: Boolean? = null): dynamic
...
external open class GameObjectFactory(game: Phaser.Game) {
    ...
    open fun button(x: Number? = null, y: Number? = null, key: String? = null, callback: ()->Unit? , callbackContext: Any? = null, overFrame: Any? = null, outFrame: Any? = null, downFrame: Any? = null, upFrame: Any? = null, group: Phaser.Group? = null): Phaser.Button
    ...
    open fun button(x: Number? = null, y: Number? = null, key: String? = null, callback: (Button,Pointer)->Unit? , callbackContext: Any? = null, overFrame: Any? = null, outFrame: Any? = null, downFrame: Any? = null, upFrame: Any? = null, group: Phaser.Group? = null): Phaser.Button
    open fun button(x: Number? = null, y: Number? = null, key: String? = null, callback: (Button,Pointer,Boolean)->Unit? , callbackContext: Any? = null, overFrame: Any? = null, outFrame: Any? = null, downFrame: Any? = null, upFrame: Any? = null, group: Phaser.Group? = null): Phaser.Button
    open fun emitter(x: Number? = null, y: Number? = null, maxParticles: Number? = null): Phaser.Particles.Arcade.Emitter
...
external open class Group(game: Phaser.Game, parent: PIXI.DisplayObjectContainer? = null, name: String? = null, addToStage: Boolean? = null, enableBody: Boolean? = null, physicsBodyType: Number? = null) : PIXI.DisplayObjectContainer() {
    ...
    open fun create(x: Number, y: Number, key: String? = null, frame: Number? = null, exists: Boolean? = null, index: Number? = null):Sprite
    ...
    open fun <T>create(x: Number, y: Number, key: Phaser.Video? = null): T
    ...
    open fun customSort(sortHandler: (Particle,Particle)->Int, context: Any? = null): Unit
    ...
    open fun forEachAlive(callback: (Sprite)->Unit, callbackContext: Any? = null, vararg args: Any): Unit
    ...
    open fun iterate(key: String, value: Any, returnType: Number, callback: Function<Any>? = null, callbackContext: Any? = null, vararg args: Any): Sprite
...
external open class Loader(game: Phaser.Game) {
    ...
    open fun image(key: String, url: Any? = null, w:Int, h:Int): Phaser.Loader
...
external open class Math {
    companion object {
        ...
        fun ceilTo(value: Number, place: Number? = null, base: Number? = null): Double
        ...
        fun distancePow(xy: Number, y1: Number, x2: Number, y2: Number, pow: Number? = null): Double
        ...
        fun normalizeAngle(angle: Number, radians: Boolean? = null): Double
        fun percent(a: Number, b: Number, base: Number? = null): Double
        fun p2px(v: Number): Double
        fun radToDeg(radians: Number): Double
        fun reverseAngle(angleRed: Number): Double
        fun rotateToAngle(currentAngle: Number, targetAngle: Number, lerp: Number? = null): Double
        fun roundAwayFromZero(value: Number): Double
        //fun round(value: Number): Double
        fun roundTo(value: Number, place: Number? = null, base: Number? = null): Double
        fun shear(n: Number): Double
        fun sign(x: Number): Double
        //fun sin(x: Number): Double
        //fun cos(x: Number): Double
        fun sinCosGenerator(length: Number, sinAmplitude: Number? = null, cosAmplitude: Number? = null, frequency: Number? = null): SinCosGenerator
        fun smootherstep(x: Number, min: Number, max: Number): Double
        fun smoothstep(x: Number, min: Number, max: Number): Double
        fun snapTo(input: Number, gap: Number, start: Number? = null): Double
        fun snapToCeil(input: Number, gap: Number, start: Number? = null): Double
        fun snapToFloor(input: Number, gap: Number, start: Number? = null): Double
        fun within(a: Number, b: Number, tolerance: Number): Boolean
        fun wrap(value: Number, min: Number, max: Number): Double
        fun wrapAngle(angle: Number, radians: Boolean? = null): Double
...
external open class Physics(game: Phaser.Game, config: Any? = null) {
    ...
    open fun enable(spr: Sprite, system: Number? = null, debug: Boolean? = null): Unit
    open fun enable(spr: TileSprite, system: Number? = null, debug: Boolean? = null): Unit
    open fun enable(spr: PIXI.Sprite, system: Number? = null, debug: Boolean? = null): Unit
    open fun enable(array: Array<TileSprite>, system: Number? = null, debug: Boolean? = null): Unit
    open fun enable(array: Array<PIXI.Sprite>, system: Number? = null, debug: Boolean? = null): Unit
    open fun enable(array: Array<Sprite>, system: Number? = null, debug: Boolean? = null): Unit
    //open fun enable(array: Array<Sprite>, system: Number? = null, debug: Boolean? = null): Unit
    ...
    open class Arcade(game: Phaser.Game) {
        ...
        open fun angleBetween(source: Any, target: Any, world: Boolean? = null): Double
        open fun angleToPointer(displayObject: Any, pointer: Phaser.Pointer? = null, world: Boolean? = null): Double
        open fun angleToXY(displayObject: Any, x: Number, y: Number, world: Boolean? = null): Double
        open fun collide(object1: Any, object2: Any? = null): Boolean
        open fun collide(object1: Any, object2: Any? = null, collideCallback: (Sprite, Sprite) -> Unit?, processCallback: Function<Any>? = null, callbackContext: Any? = null): Boolean
        ...
        open fun distanceBetween(source: Any, target: Any, world: Boolean? = null): Double
        open fun distanceToPointer(displayObject: Any, pointer: Phaser.Pointer? = null, world: Boolean? = null): Double
        open fun distanceToXY(displayObject: Any, x: Number, y: Number, world: Boolean? = null): Double
        //@JsName("enable")
        ...
        open fun moveToObject(displayObject: Any, destination: Any, speed: Number? = null, maxTime: Number? = null): Double
        open fun moveToPointer(displayObject: Any, speed: Number? = null, pointer: Phaser.Pointer? = null, maxTime: Number? = null): Double
        open fun moveToXY(displayObject: Any, x: Number, y: Number, speed: Number? = null, maxTime: Number? = null): Double
        open fun overlap(object1: Any, object2: Any, overlapCallback: (Sprite,Sprite)->Unit, processCallback: Function<Any>? = null, callbackContext: Any? = null): Boolean
    ...
    */
    ...
    @JsName("Phaser.Physics.P2")
        open class P2(game: Phaser.Game, config: Any? = null) {
            ...
            open fun createBody(x: Number, y: Number, mass: Number, addToWorld: Boolean? = null, options: p2.BodyOptions? = null, data: Array<Array<Number>>? = null): Phaser.Physics.P2.Body
            open fun createBody(x: Number, y: Number, mass: Number, addToWorld: Boolean? = null, options: p2.BodyOptions? = null, data: Array<Number>? = null): Phaser.Physics.P2.Body
            ...
            open fun createContactMaterial(materialA: Phaser.Physics.P2.Material, materialB: Phaser.Physics.P2.Material, options: IContactMaterialOptions? = null): Phaser.Physics.P2.ContactMaterial
            open fun createDistanceConstraint(bodyA: Any, bodyB: Any, distance: Number, localAnchorA: Array<Number>? = null, localAnchorB: Array<Number>? = null, maxForce: Number? = null): p2.DistanceConstraint
            ...
            open fun createParticle(x: Number, y: Number, mass: Number, addToWorld: Boolean? = null, options: p2.BodyOptions? = null, data: Array<Array<Number>>? = null): Phaser.Physics.P2.Body
            open fun createParticle(x: Number, y: Number, mass: Number, addToWorld: Boolean? = null, options: p2.BodyOptions? = null, data: Array<Number>? = null): Phaser.Physics.P2.Body
            ...
            open fun createRevoluteConstraint(bodyA: Any, pivotA: Array<Number>, bodyB: Any, pivotB: Array<Double>, maxForce: Number? = null, worldPivot: Array<Number>? = null): Phaser.Physics.P2.RevoluteConstraint
            open fun createRotationalSpring(bodyA: Any, bodyB: Any, restAngle: Number? = null, stiffness: Number? = null, damping: Number? = null): p2.RotationalSpring
            ...
            //companion object {
                ...
                open class Body(game: Phaser.Game, sprite: Phaser.Sprite? = null, x: Number? = null, y: Number? = null, mass: Number? = null):p2.Body() {
                    ...
                    open fun addCapsule(length: Number, radius: Number, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Capsule
                    open fun addCircle(radius: Number, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Circle
                    open fun addFixture(fixtureData: String): Array<p2.Shape>
                    open fun addLine(length: Number, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Line
                    open fun addParticle(offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Particle
                    ...
                    open fun addPlane(offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Plane
                    open fun addRectangle(width: Number, height: Number, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Rectangle
                    open fun addShape(shape: p2.Shape, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Shape
                    ...
                    open fun clearCollision(clearGroup: Boolean? = null, cleanMask: Boolean? = null, shape: p2.Shape? = null): Unit
                    open fun clearShapes(): Unit
                    open fun collides(group: Any, callback: Function<Any>? = null, callbackContext: Any? = null, shape: p2.Shape? = null): Unit
                    ...
                    open fun preUpdate(): Unit
                    open fun postUpdate(): Unit
                    open fun removeCollisionGroup(group: Any, clearCallback: Boolean? = null, shape: p2.Shape? = null): Unit
                    ...
                    open fun setCircle(radius: Number, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Circle
                    open fun setCollisionGroup(group: Phaser.Physics.P2.CollisionGroup, shape: p2.Shape? = null): Unit
                    open fun setRectangle(width: Number? = null, height: Number? = null, offsetX: Number? = null, offsetY: Number? = null, rotation: Number? = null): p2.Rectangle
                    open fun setRectangleFromSprite(sprite: Any): p2.Rectangle
                    open fun setMaterial(material: Phaser.Physics.P2.Material, shape: p2.Shape? = null): Unit
                    ...
                    open fun updateCollisionMask(shape: p2.Shape? = null): Unit
                    companion object {
                        var DYNAMIC: Number
                        var STATIC: Number
                ...
                open class BodyDebug(game: Phaser.Game, body: Phaser.Physics.P2.Body, settings: `T$8`) : Phaser.Group(game) {
                ...
                open class GearConstraint(world: Phaser.Physics.P2, bodyA: Phaser.Physics.P2.Body, bodyB: Phaser.Physics.P2.Body, angle: Number? = null, ratio: Number? = null)/* : p2.GearConstraint()*/ {
                    open var game: Phaser.Game
                    open var world: Phaser.Physics.P2
                }
                ...
                open class LockConstraint(world: Phaser.Physics.P2, bodyA: Phaser.Physics.P2.Body, bodyB: Phaser.Physics.P2.Body, offset: Array<Number>? = null, angle: Number? = null, maxForce: Number? = null) /*: p2.LockConstraint()*/ {
                    open var game: Phaser.Game
                    open var world: Phaser.Physics.P2
                }
                ...
                open class PrismaticConstraint(world: Phaser.Physics.P2, bodyA: Phaser.Physics.P2.Body? = null, bodyB: Phaser.Physics.P2.Body? = null, lockRotation: Boolean? = null, anchorA: Array<Number>? = null, anchorB: Array<Number>? = null, axis: Array<Number>? = null, maxForce: Number? = null)/* : p2.PrismaticConstraint()*/ {
                   open var game: Phaser.Game
                    open var world: Phaser.Physics.P2
                }
                open class RevoluteConstraint(world: Phaser.Physics.P2, bodyA: Phaser.Physics.P2.Body, pivotA: Array<Number>, bodyB: Phaser.Physics.P2.Body, pivotB: Array<Number>, maxForce: Number? = null) /*: p2.RevoluteConstraint()*/ {
                    open var game: Phaser.Game
                    open var world: Phaser.Physics.P2
                }
...
//}
    ...
    external open class Video(game: Phaser.Game, key: String? = null, url: String? = null) {
        ...
        open fun grab(clear: Boolean? = null, alpha: Number? = null): Phaser.BitmapData
...
external open class Plugin() : IStateCycle {
    constructor(game: Phaser.Game, parent: Phaser.PluginManager):this()
    open var active: Boolean
    open var game: Phaser.Game
    ...
    //companion object {
        ...
        open class TilemapWalker(game: Phaser.Game, map: Phaser.Tilemap, layer: Any? = null, x: Number? = null, y: Number? = null) : Phaser.Plugin() {
        ...
        open class Juicy(game: Phaser.Game) : Phaser.Plugin() {
            ...
            //companion object {
                open class Trail(game: Phaser.Game, trailLength: Number? = null, color: Number? = null) {
                    open var target: Phaser.Sprite
                ...
                open class ScreenFlash(game: Phaser.Game, color: String? = null) {
...
external open class PluginManager(game: Phaser.Game) : IStateCycle {
    ...
    @JsName("Phaser.Point")
    external open class Point(x: Number? = null, y: Number? = null)  {
        open var x: Double
        open var y: Double
        open var type: Number
    ...
    external open class Polygon() {
        constructor(points: Array<Phaser.Point>):this()
        constructor(points: Array<Number>):this()
        constructor(vararg points: Phaser.Point):this()
        constructor(vararg points: Number):this()
    ...
    @JsName("Phaser.Rectangle")
    external open class Rectangle(x: Number = 0, y: Number = 0, width: Number = 0, height: Number = 0):PIXI.DisplayObject() {
    ...
    external open class RenderTexture(game: Phaser.Game, width: Number? = null, height: Number? = null, key: String? = null, scaleMode: Number? = null, resolution: Number? = null) {
        ...
        open var baseTexture: PIXI.BaseTexture = noImpl
        ...
        open fun render(displayObject: PIXI.DisplayObject): Unit = noImpl
        open fun render(displayObject: PIXI.DisplayObject, matrix: PIXI.Matrix?, clear: Boolean?): Unit = noImpl
    ...
    external open class SignalT : SignalBase() {
        open fun <T> add(listener: (T) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
        open fun <T, S> add(listener: (T, S) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
    }
    ...
    external open class Signal2<T, S> : SignalBase() {
        open fun add(listener: () -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
        open fun add(listener: (T) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
        open fun add(listener: (T, S) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
    }

    external open class Signal3<T, S, Q> : SignalBase() {
        open fun add(listener: (T, S, Q) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
    }

    external open class Signal4<T, S, Q, W> : SignalBase() {
        open fun add(listener: (T, S, Q, W) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
    }

    external open class Signal5<T, S, Q, W, E> : SignalBase() {
        open fun add(listener: (T, S, Q, W, E) -> Unit, listenerContext: Any? = null, priority: Number? = null, vararg args: Any): Phaser.SignalBinding
    }
    ...
    */
        ...
        open fun destroy(destroyChildren: Boolean?, unknown: Boolean?)
    ...
    */open fun clearColors(): Phaser.Text
    ...
    external open class Tilemap(game: Phaser.Game, key: String? = null, tileWidth: Number? = null, tileHeight: Number? = null, width: Number? = null, height: Number? = null) {
        ...
        open fun addTilesetImage(tileset: String, key: String?, tileWidth: Number? = null, tileHeight: Number? = null, tileMargin: Number? = null, tileSpacing: Number? = null, gid: Number? = null): Phaser.Tileset
        open fun addTilesetImage(tileset: String, key: Phaser.BitmapData?, tileWidth: Number? = null, tileHeight: Number? = null, tileMargin: Number? = null, tileSpacing: Number? = null, gid: Number? = null): Phaser.Tileset
    ...
    external open class TilemapLayer(game: Phaser.Game, tilemap: Phaser.Tilemap, index: Number, width: Number? = null, height: Number? = null) : Phaser.Sprite(game, 0, 0) {
        ...
        open fun getRayCastTiles(line: Phaser.Line, stepRate: Number? = null, collides: Boolean? = null, interestingFace: Boolean? ): Array<Phaser.Tile>
        open fun getRayCastTiles(layer: Phaser.TilemapLayer, line: Phaser.Line, stepRate: Number? = null, collides: Boolean? = null, interestingFace: Boolean? ): Array<Phaser.Tile>
        open fun getRayCastTiles(layer: Phaser.TilemapLayerGL, line: Phaser.Line, stepRate: Number? = null, collides: Boolean? = null, interestingFace: Boolean?): Array<Phaser.Tile>
    ...
    external open class Tween(target: Any, game: Phaser.Game, manager: Phaser.TweenManager) {
        ...
        open fun to(properties: Any, duration: Number? = null, ease: String?, autoStart: Boolean? = null, delay: Number? = null, repeat: Number? = null, yoyo: Boolean? = null): Phaser.Tween
        open fun update(time: Number): Boolean
    ...
    external open class Utils {
        ...
        open class Debug(game: Phaser.Game) {
            ...
            open fun rectangle(obj: dynamic, color: String? = null, filled: Boolean? = null): Unit
            ...
            open fun text(text: Any, x: Number, y: Number, color: String? = null, font: String? = null): Unit
