...
class RemoveSpring: State() {
	...
	lateinit var spring: Physics.P2.Spring
	...
	override fun create() {
	    ...
	    val text = game.add.text(20, 20, "move with arrow keys, click to remove spring", TextStyle(fill="#ffffff" ))
	
	    cursors = game.input.keyboard.createCursorKeys()
	
	    game.input.onDown.add(this::removeSpring, this)
